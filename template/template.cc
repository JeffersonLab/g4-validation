...
void PrintUsage() {
	...
	G4cerr << " Usage: " << G4endl;
	G4cerr << G4endl;
	G4cerr << "  template_project_name [-m macro ] [-u UIsession] [-t nThreads] [-p physList ]  [-v | --verbose ] [-h | --help] [ -pap | --printAvailablePhysics ]" << G4endl;
	G4cerr << G4endl;
...
int main(int argc,char** argv)
{
	...
	auto detConstruction = new template_project_name::DetectorConstruction();
	...
	auto actionInitialization = new template_project_name::ActionInitialization(detConstruction);
