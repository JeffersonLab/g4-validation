...
RunAction::RunAction(EventAction *eventAction, G4String of)
		: fEventAction(eventAction), output_file(of) {
	...
	// Book ntuple
	if (fEventAction) {
		analysisManager->CreateNtuple("elastic", "elastic physics validation");
